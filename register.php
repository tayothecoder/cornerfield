    ...
    <div class="w-full max-w-2xl relative z-10">
        <div class="bg-white/95 dark:bg-slate-800/95 backdrop-blur-xl border border-white/20 dark:border-slate-700/50 rounded-3xl shadow-2xl shadow-cf-primary/20 p-8 transform transition-all duration-700">
            ...
            <div>
                    ...
                    <div class="bg-gray-50 dark:bg-slate-700/50 rounded-2xl p-6">
                        <label class="flex items-start gap-3 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300">
                                I agree to the <a href="/terms.php" target="_blank" class="text-cf-primary hover:text-cf-primary-dark transition-colors font-medium">Terms and Conditions</a> 
                                and <a href="/privacy.php" target="_blank" class="text-cf-primary hover:text-cf-primary-dark transition-colors font-medium">Privacy Policy</a> 
                ...
                <!-- Login Link -->
                <a href="/login.php" class="w-full flex items-center justify-center gap-2 bg-white dark:bg-slate-700 border-2 border-gray-200 dark:border-slate-600 text-gray-700 dark:text-gray-300 font-semibold py-3 px-4 rounded-xl transition-all duration-200 hover:border-cf-primary hover:text-cf-primary transform hover:scale-[1.02]">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="flex items-center justify-between mt-8 text-xs text-gray-500 dark:text-gray-400">
                ...
                <a href="/help.php" class="hover:text-cf-primary transition-colors">Need Help?</a>
            </div>
        </div>
    </div>
