...
// Navigation items
$navItems = [
    'dashboard' => ['title' => 'Dashboard', 'icon' => 'home', 'url' => '/users/dashboard.php'],
    'invest' => ['title' => 'Invest', 'icon' => 'trending-up', 'url' => '/users/invest.php'],
    'transactions' => ['title' => 'Transactions', 'icon' => 'list-bullet', 'url' => '/users/transactions.php'],
    'transfer' => ['title' => 'Transfer', 'icon' => 'arrow-right-circle', 'url' => '/users/transfer.php'],
    'referrals' => ['title' => 'Referrals', 'icon' => 'user-group', 'url' => '/users/referrals.php'],
    'profile' => ['title' => 'Profile', 'icon' => 'user-circle', 'url' => '/users/profile.php'],
    'settings' => ['title' => 'Settings', 'icon' => 'cog-6-tooth', 'url' => '/users/settings.php'],
    'support' => ['title' => 'Support', 'icon' => 'chat-bubble-left-right', 'url' => '/users/support.php']
];
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-800 transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0">
            <div class="flex flex-col h-full">
                ...
                <div class="px-6 py-4 bg-slate-700 border-b border-slate-600">
                    <div class="flex items-center">
                        <img class="w-10 h-10 rounded-full object-cover" src="<?= htmlspecialchars($user['avatar']) ?>" alt="<?= htmlspecialchars($user['firstname']) ?>" onerror="this.src='/assets/images/default-avatar.png'">
                        <div class="ml-3">
                ...
                <div class="px-4 py-4 border-t border-slate-700">
                    <a href="/logout.php" class="group flex items-center px-3 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-slate-700 rounded-lg transition-all duration-200">
                ...
                <div class="flex items-center justify-between px-4 py-4 sm:px-6">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:flex space-x-2">
                            <a href="/users/deposit.php" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors">
                                Deposit
                            </a>
                            <a href="/users/withdraw.php" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors">
                                Withdraw
                            </a>
                        </div>
                    </div>
